...
(function (global) {
  ...
  /* ── service ──────────────────────────────────────────
     ...
     domain … 提示対象かの判定（§8-2）
     post_mortem_procedure … null なら対応時期「いまのうち」（§10-2）  */
  const SERVICES = {
    ...
    'svc-anytime':  { name: 'エニタイムフィットネス', merchant_id: 'mch-anytime', category: 'フィットネス',
                      pricing_type: 'monthly', domain: 'contract_digital',
                      post_mortem_procedure: '本人死亡時は所属店舗またはコールセンターで退会手続き。会員カードと本人確認書類が必要。' },
